...
import evolution_colab_phase3  # The new engine
...
def run_5bit_adder_bitwise():
    ...
    # Use BitwiseConfig
    cfg = evolution_colab_phase3.BitwiseConfig(
        num_gates=60, 
    ...
    best_ind_raw, best_bkd, hof, history = evolution_colab_phase3.evolve_bitwise(
    ...
    best_ind_str = evolution_colab_phase3.convert_to_string_format(best_ind_raw, n_in)
