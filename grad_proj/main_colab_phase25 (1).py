...
# Features: 5 Menu Options, Robust VHDL, Plotting Fixes

import matplotlib.pyplot as plt
import numpy as np
import sys
import vhdl_generator_1  # Ensure you updated this file!

# Import Engine (Handles Phase 23)
try:
...
def run_and_visualize(n_in, n_out, inputs, targets, cfg, title="Evolution Run"):
    ...
    # 1. Run Evolution (Unpacking 4 values now)
    ...
    print("\n💾 Generating VHDL...")
    try:
        # Pass list directly to updated generator
...
def run_3bit_adder():
    ...
    run_and_visualize(n_in, n_out, inputs, [t_s0, t_s1, t_s2, t_cout], cfg, "3-bit Adder")
...
def run_5bit_adder_complex():
    ...
    cfg = ColabConfig(
        num_gates=60, # Increased for 5-bit
        pop_size=2500, # Increased
        generations=6000, 
        elitism=30,
        tournament_k=8,
