# main_colab_phase34.py
# Phase 3.4 Driver

import matplotlib.pyplot as plt
import numpy as np
import sys
import vhdl_generator_1 # Use your robust VHDL generator
import evolution_colab_phase35 # The new engine
...
def run_5bit_adder_bitwise():
    ...
    cfg = evolution_colab_phase35.BitwiseConfig(
        num_gates=200, 
        pop_size=3000,
        generations=6000, 
        elitism=150,
        tournament_k=10,
        base_mut=0.05, min_mut=0.00005, 
    ...
    print("🚀 Starting Phase 3.4 (Locking + Specialist Elitism)...")
    
    best_ind_raw, best_bkd, hof, history = evolution_colab_phase35.evolve_bitwise(
        n_in, n_out, inputs, targets, cfg
    )
    
    print("Converting genome for export...")
    best_ind_str = evolution_colab_phase35.convert_to_string_format(best_ind_raw, n_in)
